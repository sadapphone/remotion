...
export const RichestCard: React.FC<{
  ...
  <div className="flex justify-center p-0" style={style}>
    <div className="w-full max-w-[500px] overflow-hidden rounded-xl shadow-2xl bg-white border border-gray-200 transform transition-all duration-300 hover:shadow-[0_25px_70px_-12px_rgba(0,0,0,0.35)] hover:scale-105">
      ...
      <div className="relative">
        ...
        <div className="h-36 bg-gradient-to-r from-blue-800 via-blue-600 to-indigo-900"></div>

        {/* Avatar - Overlapping Position */}
        <div className="flex justify-center -mt-16">
          <div className="w-32 h-32 rounded-full border-6 border-white shadow-xl overflow-hidden bg-white">
            <img
      ...
      <div className="px-6 pt-4 pb-3 text-center">
        ...
        <div className="flex justify-center my-2">
          <span className="bg-blue-100 text-blue-800 text-sm font-semibold px-4 py-1 rounded-full flex items-center gap-2">
      ...
      <div className="px-6 py-4 bg-gradient-to-r from-green-600 via-emerald-500 to-teal-600 text-white text-center">
        <p className="text-sm uppercase font-semibold tracking-wider opacity-90 mb-1">
          Net Worth
        </p>
