...
export const RichestCard: React.FC<{
  ...
  <div className="flex justify-center p-0" style={style}>
    <div className="w-full max-w-[350px] overflow-hidden rounded-xl shadow-2xl bg-white border border-gray-200 transform transition-all duration-300 hover:shadow-[0_25px_70px_-12px_rgba(0,0,0,0.35)] hover:scale-105">
      ...
      <div className="px-10 pt-8 pb-5 text-center">
        <h1 className="text-5xl font-bold text-gray-800 tracking-tight leading-tight">
        ...
        <div className="flex justify-center my-4">
          <span className="bg-blue-100 text-blue-800 text-lg font-semibold px-6 py-2 rounded-full flex items-center gap-2.5">
            <MapPin className="h-5 w-5" /> {person.country}{" "}
            {person.flag || "🌍"}
          </span>
        </div>
      </div>
      ...
      <div className="px-10 py-8 bg-gradient-to-r from-green-600 via-emerald-500 to-teal-600 text-white text-center">
        <p className="text-xl uppercase font-semibold tracking-wider opacity-90 mb-3">
          Net Worth
        </p>
